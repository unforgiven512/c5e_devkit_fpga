// c5efa7_bts_general_qsys_tristate_conduit_pin_sharer.v

// This file was auto-generated from altera_tristate_conduit_pin_sharer_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 12.1sp1 243 at 2013.02.13.11:08:25

`timescale 1 ps / 1 ps
module c5efa7_bts_general_qsys_tristate_conduit_pin_sharer (
		...
		output wire [0:0]  max5_inf_tcm_read_n_out,        //      .max5_inf_tcm_read_n_out_out
		output wire [0:0]  max5_inf_tcm_write_n_out,       //      .max5_inf_tcm_write_n_out_out
		output wire [0:0]  max5_inf_tcm_reset_out,         //      .max5_inf_tcm_reset_out_out
		output wire [0:0]  max5_inf_tcm_chipselect_n_out,  //      .max5_inf_tcm_chipselect_n_out_out
		...
		input  wire [25:0] tcs2_address_out,               //      .address_out
	...
	wire        pin_sharer_tcs1_arb_valid; // pin_sharer:arb_max5_inf_tcm -> arbiter:sink1_valid
	wire        pin_sharer_tcs0_arb_valid; // pin_sharer:arb_ssram_tcm -> arbiter:sink0_valid

	c5efa7_bts_general_qsys_tristate_conduit_pin_sharer_pin_sharer pin_sharer (
		.clk                            (clk_clk),                        //      clk.clk
		...
		.max5_inf_tcm_read_n_out        (max5_inf_tcm_read_n_out),        //         .max5_inf_tcm_read_n_out_out
		.max5_inf_tcm_write_n_out       (max5_inf_tcm_write_n_out),       //         .max5_inf_tcm_write_n_out_out
		.max5_inf_tcm_reset_out         (max5_inf_tcm_reset_out),         //         .max5_inf_tcm_reset_out_out
		.max5_inf_tcm_chipselect_n_out  (max5_inf_tcm_chipselect_n_out),  //         .max5_inf_tcm_chipselect_n_out_out
		...
		.tcs1_tcm_reset_out             (tcs1_reset_out),                 //         .reset_out
		...
		.arb_max5_inf_tcm               (pin_sharer_tcs1_arb_valid),      // tcs1_arb.valid
		.arb_ssram_tcm                  (pin_sharer_tcs0_arb_valid)       // tcs0_arb.valid
	);

	c5efa7_bts_general_qsys_tristate_conduit_pin_sharer_arbiter arbiter (
		.clk         (clk_clk),                   //       clk.clk
