// c5efa7_bts_general_qsys_max5_inf.v
...
`timescale 1 ps / 1 ps
module c5efa7_bts_general_qsys_max5_inf #(
		parameter TCM_ADDRESS_W                  = 9,
		parameter TCM_DATA_W                     = 16,
		parameter TCM_BYTEENABLE_W               = 2,
		parameter TCM_READ_WAIT                  = 4,
		parameter TCM_WRITE_WAIT                 = 2,
		parameter TCM_SETUP_WAIT                 = 2,
		parameter TCM_DATA_HOLD                  = 2,
		parameter TCM_TURNAROUND_TIME            = 2,
		parameter TCM_TIMING_UNITS               = 1,
		...
		input  wire [8:0]  uas_address,          //   uas.address
		...
		output wire        tcm_reset_out,        //      .reset_out
		output wire        tcm_request,          //      .request
		input  wire        tcm_grant,            //      .grant
		output wire [8:0]  tcm_address_out,      //      .address_out
	...
	wire   [8:0] tdt_avalon_universal_master_0_address;           // tdt:m0_uav_address -> slave_translator:uav_address
	...
	wire   [8:0] slave_translator_avalon_anti_slave_0_address;    // slave_translator:av_address -> tda:av_address
	...
	altera_tristate_controller_aggregator #(
		...
		.tcm0_reset_output      (tcm_reset_out),                                   //                          .reset_out
