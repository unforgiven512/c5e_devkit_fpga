// q_sys_mem_if_lpddr2_emif_0_dmaster.v
...
`timescale 1 ps / 1 ps
module q_sys_mem_if_lpddr2_emif_0_dmaster #(
		parameter USE_PLI     = 0,
	...
	q_sys_master_0_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	q_sys_master_0_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	q_sys_master_0_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
