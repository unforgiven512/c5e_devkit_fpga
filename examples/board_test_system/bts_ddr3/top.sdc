...
set_false_path -from * -to [get_ports {ddr3_resetn}]
...
set_false_path -from [get_clocks {u0|pll_0|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -to [get_clocks {u0|mem_if_ddr3_emif_0|pll0|pll_write_clk}]
set_false_path -from [get_clocks {u0|mem_if_ddr3_emif_0|pll0|pll_write_clk}] -to [get_clocks {u0|pll_0|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]
set_false_path -from [get_clocks {u0|mem_if_ddr3_emif_0|pll0|pll_afi_clk}] -to [get_clocks {u0|pll_0|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]