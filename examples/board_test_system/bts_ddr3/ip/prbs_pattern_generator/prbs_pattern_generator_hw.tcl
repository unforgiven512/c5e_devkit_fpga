...
set_module_property DISPLAY_NAME "PRBS Pattern Generator"
...
add_parameter PRBS_WIDTH INTEGER 32
set_parameter_property PRBS_WIDTH DEFAULT_VALUE 32
set_parameter_property PRBS_WIDTH DISPLAY_NAME "PRBS Width"
set_parameter_property PRBS_WIDTH UNITS None
set_parameter_property PRBS_WIDTH ALLOWED_RANGES {8 16 32 64 128}
set_parameter_property PRBS_WIDTH DESCRIPTION "PRBS width"
set_parameter_property PRBS_WIDTH DISPLAY_HINT ""
set_parameter_property PRBS_WIDTH AFFECTS_GENERATION false
set_parameter_property PRBS_WIDTH HDL_PARAMETER true
...
proc validate_me {}  {
  if { [get_parameter_value DATA_WIDTH] < [get_parameter_value PRBS_WIDTH] }  {
    send_message Error "You must set the DATA_WIDTH to be bigger than PRBS_WIDTH"
  }
}
