...
lappend arg_list "--component-param=MEM_IF_READ_DQS_WIDTH=4"
lappend arg_list "--component-param=DUAL_WRITE_CLOCK=false"
lappend arg_list "--component-param=MEM_IF_DQ_WIDTH=32"
lappend arg_list "--component-param=MEM_IF_DM_WIDTH=4"
...
lappend arg_list "--component-param=CALIB_VFIFO_OFFSET=10"
lappend arg_list "--component-param=CALIB_LFIFO_OFFSET=7"
...
lappend arg_list "--component-param=AFI_DATA_WIDTH=128"
lappend arg_list "--component-param=AFI_DATA_MASK_WIDTH=16"
lappend arg_list "--component-param=AFI_DQS_WIDTH=8"
lappend arg_list "--component-param=MEM_IF_WRITE_DQS_WIDTH=4"
...
lappend arg_list "--component-param=SEQ_ROM=q_sys_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=q_sys_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=q_sys_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=23552"
lappend arg_list "--component-param=SEQUENCER_MEM_ADDRESS_WIDTH=13"
lappend arg_list "--output-name=q_sys_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:q_sys_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:q_sys_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "D:/altera/12.1sp1b243/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
