...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../c5efa7_fpga_bup.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../../c5efa7_fpga_bup_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is c5efa7_fpga_bup_qsys
SOPC_NAME := c5efa7_fpga_bup_qsys
...
# The SOPC System ID 
# setting SOPC_SYSID is -87110914
SOPC_SYSID_FLAG += --id=-87110914
ELF_PATCH_FLAG  += --id -87110914

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x9000088
SOPC_SYSID_FLAG += --sidp=0x9000088
ELF_PATCH_FLAG  += --sidp 0x9000088

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1360739470
SOPC_SYSID_FLAG += --timestamp=1360739470
ELF_PATCH_FLAG  += --timestamp 1360739470
