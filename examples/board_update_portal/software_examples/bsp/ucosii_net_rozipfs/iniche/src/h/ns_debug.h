...
/*
 * $Id: //depot/projects/devkits/cycloneVE_5cefa7f31_fpga_v12.1.1.0/examples/board_update_portal/software_examples/bsp/ucosii_net_rozipfs/iniche/src/h/ns_debug.h#1 $
 * $Log: ns_debug.h,v $
