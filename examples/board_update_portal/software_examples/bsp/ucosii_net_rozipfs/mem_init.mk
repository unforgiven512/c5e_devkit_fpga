...
MEM_0 := c5efa7_fpga_bup_qsys_descriptor_memory
...
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_1)_lane0.dat
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_1)_lane1.dat
...
# Memory: onchip_ram
MEM_2 := c5efa7_fpga_bup_qsys_onchip_ram
...
$(MEM_2)_START := 0x08200000
$(MEM_2)_END := 0x0827ffff
...
.PHONY: onchip_ram
onchip_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
...
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_3)_lane0.dat
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_3)_lane1.dat
SYM_FILES += $(HDL_SIM_DIR)/$(MEM_3).sym
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_3).sym
$(MEM_3)_START := 0x07000000
$(MEM_3)_END := 0x071fffff
$(MEM_3)_HIERARCHICAL_PATH := ssram
$(MEM_3)_WIDTH := 16
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 1

.PHONY: ssram
ssram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
